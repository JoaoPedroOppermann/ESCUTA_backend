...
class AuthController extends Controller
{
    ...
    public function redefinicaoPassword()
    {
        $credenciais = request()->validate(['email'=>'required|email']);
        Password::sendResetLink($credenciais);
        return $this->respondWithMessage("Faça a redefinição de sua senha nesse link a seguir.");
    }
